...

{
 ...
 Client c = s.available(); //Usa el cliente   
...

{
     ...
     switch(m)  
     {
     case 'M':s.write('M' + out);myTextarea.append("Server: " + output);break;
     case 'U':s.write('U' + UserName + ':' + out);myTextarea.append(UserName + ": " + output);break;
     }
     }
